...
import com.suicxde.carminder.Activities.AddcarActivity;
import com.suicxde.carminder.Database.RemindersDbAdapter;
import com.suicxde.carminder.ReminderManager;
...
public class OnBootReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(cursor != null) {
			...
			int dateTimeColumnIndex = cursor.getColumnIndex(RemindersDbAdapter.S_REMIND);
			while(cursor.isAfterLast() == false) {
				...
				SimpleDateFormat format = new SimpleDateFormat(AddcarActivity.DATE_TIME_FORMAT);
